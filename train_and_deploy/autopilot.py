...
model.load_state_dict(torch.load("models/DonkeyNet_volleyball300_sunny_20Epochs.pth", map_location=torch.device('cpu')))

# Setup Transforms
img2tensor = ToTensor()
resize = Resize(size=(300,300)) #changed from 120*160
